...
- Run `pnpm intent list` from the workspace root to see available local skills.
- If a listed skill matches the task, run `pnpm intent load <package>#<skill>` before changing files.
