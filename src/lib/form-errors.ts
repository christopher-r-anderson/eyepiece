...
// server-side validation failures across features spell this one code
// (profiles' INVALID_INPUT_ERROR is the same literal)
...
export const FORM_ERROR_COPY: Record<string, string> = {
  ...
  [INVALID_INPUT_CODE]: 'Please check the form and try again.',
}
